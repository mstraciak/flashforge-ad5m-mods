it need apache+php (like xampp), enabled socket module in php.ini.copy files to html folder and just open http://localhost/<path_to_files>/index.php?ip=<IP_PRINTER>
